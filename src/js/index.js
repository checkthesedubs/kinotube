...
window.CLIENT.Nexus = {
	settings: {
		...
		chatWidthPxSize: Math.max(250, getOrDefault(KEY_chatWidthPxSize, 350)),
		...
		sanitizeProfileImg: getOrDefault(KEY_sanitizeProfileImg, true)
	},
	cache: {
	...
	fn: {},
	_changelogSeen: getOrDefault(KEY_changelogSeen, false),
	_last_version: getOpt(KEY_lastVersion) || "0.0.0",
	_version: "0.0.30"
}
